...
我博客里会插入一些视频文件，以前用 Hexo 的时候就自己开发了 [hexo-tag-smplayer](https://github.com/u2sb/hexo-tag-smplayer)，这次更换平台，就顺带开发了一款插件 [vuepress-plugin-smplayer](https://github.com/u2sb/vuepress-plugin-smplayer)。
